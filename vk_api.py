...
class VkApi(object):
    def __init__(self, login=None, password=None, number=None, sec_number=None,
                 ...
                 api_version='5.38', #app_id=2895443,
                 scope=33554431,
                 app_id=5391828, # AUTOLIKING !!!!
                 client_secret='DFyJmzfACOlWiGWfnmki'):
        """
        ...
        self.api_version = '5.40'
        self.app_id = app_id
        self.scope = scope
        self.client_secret = 'jdJjEgTH4MUn86dMMu2'
